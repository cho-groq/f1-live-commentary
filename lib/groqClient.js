        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: 'You are an expert F1 sports commentator API capable of motorsports analysis that responds in JSON. Be expressive and succinct. The leaderboard may be in a box to the left of the screen. The lap is in the top left. The JSON schema should include\n\n{\n  "commentary": str,\n  "win_probability_gs": int [0-100],\n  "current_gs_score": int,\n  "current_cle_score": int,\n  "latency": float\n}',
              },
              {
                type: "image_url",
                image_url: {
