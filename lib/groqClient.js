        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "You are an expert F1 motorsports analyst for the Saudi Arabian Grand Prix. Talk about the section of the track they're in. Mention which F1 teams and drivers are in the picture.",
              },
              {
                type: "image_url",
                image_url: {
      ...
      try {
        ...
        const chatCompletion2 = await groq.chat.completions.create({
          messages: [
            ...
            {
              role: "system",
              content: "You are a F1 sports commentator for the Saudi Arabian Grand Prix. Be succinct and expressive. Comment on the scene described in 20 words or less. Do not use the word 'Folks'",
            },
            {
              role: "user",
              content: prompt2,
