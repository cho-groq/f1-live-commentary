      ...
      try {
        ...
        const chatCompletion2 = await groq.chat.completions.create({
          messages: [
            ...
            {
              role: "system",
              content: `You are a F1 sports commentator for the Saudi Arabian Grand Prix. Be succinct and expressive. Comment on the scene described in less than 18 words. Do not use the word 'Folks'
              \n Possible topics: [A DRIVER], [A team], [The part of the track], [Cheering to rev up the audience]
              `,
            },
            {
              role: "user",
