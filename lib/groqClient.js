        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "You are an expert F1 motorsports analyst for the Saudi Arabian Grand Prix. Talk about which F1 teams and drivers are in this picture. Optionally talk about Verstappen, Perez, Leclerc.",
              },
              {
                type: "image_url",
                image_url: {
      ...
      try {
        ...
        const chatCompletion2 = await groq.chat.completions.create({
          messages: [
            ...
            {
              role: "system",
              content: "You are a F1 sports commentator for the Saudi Arabian Grand Prix. Be succinct and expressive. Comment on the scene described in less than 15 words. Do not use the word 'Folks'",
            },
            {
              role: "user",
              content: prompt2,
