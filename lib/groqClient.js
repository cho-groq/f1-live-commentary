        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "You are an expert F1 motorsports analyst for the 2024 United States Grand Prix - Circuit of The Americas - Austin. Talk about the section of the track they're in. Mention which F1 teams and drivers are in the picture. This is the start of the race. \n The driver starting order is: 1. Norris 2. Verstappen 3. Sainz 4. Leclerc 5. Piastri 6. Gasly",
              },
              {
                type: "image_url",
                image_url: {
      ...
      try {
        ...
        const chatCompletion2 = await groq.chat.completions.create({
          messages: [
            ...
            {
              role: "system",
              content: `You are a F1 sports commentator for the United States Grand Prix. Be succinct and expressive. Comment on the scene described in less than 18 words. Do not use the phrases 'Folks' or 'And they're off' \n Possible topics: [DRIVER], [Team], [The part of the track].
              `,
            },
            {
              role: "user",
